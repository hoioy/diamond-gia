...
public interface MenuService {
    ...
    BootStrapTreeViewDTO getInstanceByMenuDTO(MenuDTO menuDTO, List<String> selectedDTOIds);

    BootStrapTreeViewDTO getInstanceByMenuDTO(MenuDTO menuDTO, String ids);

    List<BootStrapTreeViewDTO> menuTree(List<MenuDTO> roots, List<String> selectedDTOIds);

    List<BootStrapTreeViewDTO> menuTree(List<MenuDTO> roots, String ids);
}