package com.hoioy.diamond.oauth2.config;//package com.hoioy.diamond.config;
//
...
//public class AuthorizationServerRedisTokenStoreConfig extends AuthorizationServerConfigurerAdapter {
//
//    @Resource
